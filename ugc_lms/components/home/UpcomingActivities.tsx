  ...
  return (
    <div className="enter enter-5" style={{ marginTop: 36 }}>
      ...
      <div style={{ position: 'relative', paddingLeft: 28 }}>
        {/* Vertical line */}
        <div style={{ position: 'absolute', left: 9, top: 4, bottom: 4, width: 1.5, background: 'var(--border-subtle)', borderRadius: 1 }} />
          ...
          return (
            <div key={item.id} style={{ position: 'relative', paddingBottom: isLast ? 0 : 16 }}>
              ...
              <div style={{
                ...
                <Icon size={9} strokeWidth={2.5} style={{ color: config.color }} />
              </div>
              ...
              <div
                ...
                onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 3px 12px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = config.border; }}
